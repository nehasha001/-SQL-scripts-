...
<xs:schema xmlns="http://xmlns.oracle.com/odmr11"
           ...
           version="12.1.0.2.3" xdb:storeVarrayAsTable="true">
...
<!--  <xs:complexType xdb:maintainDOM="true">
 ...
 <!--Agg.Node end-->
 <xs:complexType name="AnomalyDetectionBuildNodeType" ';

schema2 := 'xdb:maintainDOM="true">
  <xs:complexContent>
...
schema6 := 'ute name="Name" use="required">
      <xs:simpleType>
       <xs:restriction base="xs:string">
        <xs:minLength value="1"/>
        <xs:maxLength value="30"/>
